...
.seasons-wrapper { width: 100vw; position: relative; left: 50%; right: 50%; margin-left: -50vw; margin-right: -50vw; background-color: #f4f1ea; }
...
.sticky-bg { position: sticky; top: 0; width: 100vw; height: 100vh; z-index: 1; }
...
.cards-track { position: relative; z-index: 2; margin-top: -100vh; padding-bottom: 100px; }
.content-card { background: rgba(244, 241, 234, 0.98); margin: 150px 0 150px 8%; padding: 80px; max-width: 900px; min-height: 500px; border-radius: 2px; box-shadow: 0 20px 50px rgba(0,0,0,0.1); display: flex; flex-direction: column; justify-content: center; text-align: left; }
.split-layout { flex-direction: row; gap: 60px; align-items: center; }
.card-image { flex: 1.2; }
...
.content-card { margin: 80px auto; max-width: 92%; padding: 40px; }
}
</style>
